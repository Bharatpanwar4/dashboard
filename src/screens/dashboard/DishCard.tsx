...
const DishCard = () => {
  return (
    ...
    transition={{ duration: 0.5, delay: 0.5 }} className="bg-componentBg h-full p-3 md:p-4 lg:py-10 rounded-md">
...
<div className='rounded-full p-4 hover:opacity-70' style={{background:item.iconbg,color:item.col}}>
    {item.icon}
</div>
