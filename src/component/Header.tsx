import { BellDot, CircleUserRound, Mail, Search, Settings } from "lucide-react"
...
<div className="flex items-center relative">
  ...
  <input type="text" placeholder="Search" className="glassbg  w-32 md:w-fit  text-white text-sm outline-0 border border-[#7E7F83] placeholder:text-[#7E7F83] rounded-md pl-8 md:pl-10 py-2" />
</div>
