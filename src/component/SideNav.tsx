          ...
          {SidebarList?.map((item) => {
            return (
              <div
                ...
                className={`px-4 py-2 cursor-pointer text-icontext hover:text-white ${
                  item.id === activeNav
                    ? "border-l-4 border-primaryColor text-primaryColor hover:text-primaryColor"
            ...
            {SidebarList?.map((item) => {
              return (
                <div
                  ...
                  className={`px-4 py-2 cursor-pointer text-icontext hover:text-white ${
                    item.id === activeNav
                      ? "border-b-4 border-primaryColor text-primaryColor hover:text-primaryColor"
                      : "border-l-4 border-transparent"
                  }`}
                >
                  {item.iconName}
